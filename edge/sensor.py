                ...
                while True:
                    ...
                    if data_rcv_list[0] == "SENSOR":
                        ...
                        if not already_exists:
                            ...
                            new_sensor = SensorManager.Sensor(self._config, sensor_ip, sensor_port, sensor_type, self)
